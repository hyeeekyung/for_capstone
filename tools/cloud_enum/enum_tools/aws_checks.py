...
def check_s3_buckets(names, threads):
    ...
    for name in names:
        for region in AWS_REGIONS:
            # region이 'ap-northeast-2.amazonaws.com'이면 → s3.ap-northeast-2.amazonaws.com
            region_prefix = region.replace('.amazonaws.com', '')
            candidates.append(f'{name}.s3.{region_prefix}.amazonaws.com')
