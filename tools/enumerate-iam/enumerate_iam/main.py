...
def check_one_permission(arg_tuple):
    ...
    # print(f"[INFO] Testing: {service_name}.{operation_name}")

    service_client = get_client(access_key, secret_key, session_token, service_name, region)
    # print(f"{service_name}.{operation_name} get")

    if service_client is None:
        # print(f"{service_name}.{operation_name} service_client")
        return

    try:
        # print(f"{service_name}.{operation_name} getattr")
        ...
        # print(f"{service_name}.{operation_name} error")
    ...
    # print(f"i'm here {service_name}.{operation_name}")
